...
var marshallingIds_MarshalledId;
...
})(marshallingIds_MarshalledId || (marshallingIds_MarshalledId = {}));
...
class Uri extends uri_URI {
    ...
    toJSON() {
        const res = {
            $mid: marshallingIds_MarshalledId.Uri
        };
        if (this._fsPath) {
...
function trivia4and5(targetPath, pattern, matchPathEnds) {
    const usingPosixSep = sep === path_posix.sep;
    const nativePath = usingPosixSep ? targetPath : targetPath.replace(ALL_FORWARD_SLASHES, sep);
    const nativePathEnd = sep + nativePath;
    const targetPathEnd = path_posix.sep + targetPath;
    let parsedPattern;
    if (matchPathEnds) {
    ...
    const aggregate = function (path, basename) {
        ...
        if (!basename) {
            ...
            for (i = path.length; i > 0; i--) {
                ...
                if (ch === charCode_CharCode.Slash || ch === charCode_CharCode.Backslash) {
                    break;
                }
            }
...
;// ./node_modules/@codingame/monaco-vscode-search-service-override/vscode/src/vs/workbench/services/search/common/localFileSearchWorkerTypes.js
...
;// ./node_modules/@codingame/monaco-vscode-search-service-override/vscode/src/vs/workbench/services/search/common/getFileResults.js
...
;// ./node_modules/@codingame/monaco-vscode-55041ed9-a1ea-544a-883d-08b0b26934f3-common/vscode/src/vs/workbench/services/search/common/ignoreFile.js
...
class IgnoreFile {
    ...
    gitignoreLinesToExpression(lines, dirPath, trimForExclusions) {
        ...
        return glob_parse(includeExpression, { trimForExclusions });
    }
...
;// ./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/marshalling.js
...
function revive(obj, depth = 0) {
    ...
    if (typeof obj === 'object') {
        switch (obj.$mid) {
            case marshallingIds_MarshalledId.Uri: return uri_URI.revive(obj);
            case marshallingIds_MarshalledId.Regexp: return ( new RegExp(obj.source, obj.flags));
            case marshallingIds_MarshalledId.Date: return ( new Date(obj.source));
        }
...
;// ./node_modules/@codingame/monaco-vscode-search-service-override/vscode/src/vs/workbench/services/search/worker/localFileSearch.js
...
class LocalFileSearchWorker {
        ...
        return time('searchInFiles', async () => {
            ...
            const processFile = async (file) => {
                ...
                if (fileResults.length) {
                    ...
                    const match = {
                        resource: uri_URI.joinPath(revivedQuery.folder, file.path),
                        results: fileResults,
                    };
    ...
    async walkFolderQuery(handle, queryProps, folderQuery, extUri, onFile, token) {
        const folderExcludes = folderQuery.excludePattern?.map(excludePattern => glob_parse(excludePattern.pattern ?? {}, { trimForExclusions: true }));
...
function reviveFolderQuery(folderQuery) {
    return revive({
        ...revive(folderQuery),
        excludePattern: folderQuery.excludePattern?.map(ep => ({ folder: uri_URI.revive(ep.folder), pattern: ep.pattern })),
        folder: uri_URI.revive(folderQuery.folder),
    });
}
function reviveQueryProps(queryProps) {
    return {
        ...queryProps,
        extraFileResources: queryProps.extraFileResources?.map(r => uri_URI.revive(r)),
...
;// ./node_modules/@codingame/monaco-vscode-search-service-override/vscode/src/vs/workbench/services/search/worker/localFileSearchMain.js
