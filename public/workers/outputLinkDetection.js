...
;// ./node_modules/@codingame/monaco-vscode-output-service-override/vscode/src/vs/workbench/contrib/output/common/outputLinkComputer.js
...
class OutputLinkComputer {
    ...
    computePatterns(_workspaceFolders) {
        const workspaceFolders = ( _workspaceFolders
            ...
            .map(resourceStr => ( uri_URI.parse(resourceStr))));
    ...
    static createPatterns(workspaceFolder) {
        ...
        if (platform_isWindows && workspaceFolder.scheme === Schemas.file) {
        ...
        for (const workspaceFolderVariant of workspaceFolderVariants) {
            ...
            patterns.push(( new RegExp(
                escapeRegExpCharacters(workspaceFolderVariant) + `(${pathPattern}) on line ((\\d+)(, column (\\d+))?)`,
                'gi'
            )));
            patterns.push(( new RegExp(
                escapeRegExpCharacters(workspaceFolderVariant) + `(${pathPattern}):line ((\\d+)(, column (\\d+))?)`,
                'gi'
            )));
            patterns.push(( new RegExp(
                escapeRegExpCharacters(workspaceFolderVariant) + `(${pathPattern})(\\s?\\((\\d+)(,(\\d+))?)\\)`,
                'gi'
            )));
            patterns.push(( new RegExp(
                escapeRegExpCharacters(workspaceFolderVariant) + `(${strictPathPattern})(:(\\d+))?(:(\\d+))?`,
                'gi'
            )));
        }
        return patterns;
...
;// ./node_modules/@codingame/monaco-vscode-output-service-override/vscode/src/vs/workbench/contrib/output/common/outputLinkComputerMain.js
